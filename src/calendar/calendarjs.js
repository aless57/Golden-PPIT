...
function calendarJs( id, options, searchOptions, startDateTime ) {
            ...
            _element_Tooltip_ShowTimer = setTimeout( function() {
                if ( overrideShow || ( !isDisabledBackgroundDisplayed() && !isYearSelectorDropDownVisible() && !isDropDownMenuVisible( _element_DropDownMenu_Day ) && !isDropDownMenuVisible( _element_DropDownMenu_Event ) ) ) {
                    ...
                    if ( text !== "" ) {
                        ...
                        if ( isDefinedStringAndSet( eventDetails.location ) ) {
                            //TODO: ajouter image (icone) location
                            _element_Tooltip_Location.innerHTML = `<img></img> ${eventDetails.location}`;
    ...
    function setTranslationStringOptions() {
        if ( !isDefinedString( _options.previousMonthTooltipText ) ) {
            _options.previousMonthTooltipText = "Mois précédent";
        }

        if ( !isDefinedString( _options.nextMonthTooltipText ) ) {
            _options.nextMonthTooltipText = "Mois suivant";
        }

        if ( !isDefinedString( _options.previousDayTooltipText ) ) {
            _options.previousDayTooltipText = "Jour précédent";
        }

        if ( !isDefinedString( _options.nextDayTooltipText ) ) {
            _options.nextDayTooltipText = "Jour suivant";
        }

        if ( !isDefinedString( _options.previousWeekTooltipText ) ) {
            _options.previousWeekTooltipText = "Semaine précédente";
        }

        if ( !isDefinedString( _options.nextWeekTooltipText ) ) {
            _options.nextWeekTooltipText = "Semaine suivante";
        }

        if ( !isDefinedString( _options.addEventTooltipText ) ) {
            _options.addEventTooltipText = "Ajouter un événement";
        }

        if ( !isDefinedString( _options.closeTooltipText ) ) {
            _options.closeTooltipText = "Fermer";
        }

        if ( !isDefinedString( _options.exportEventsTooltipText ) ) {
            _options.exportEventsTooltipText = "Exporter les événements";
        }

        if ( !isDefinedString( _options.todayTooltipText ) ) {
            _options.todayTooltipText = "Aujourd'hui";
        }

        if ( !isDefinedString( _options.refreshTooltipText ) ) {
            _options.refreshTooltipText = "Actualiser";
        }

        if ( !isDefinedString( _options.searchTooltipText ) ) {
            _options.searchTooltipText = "Chercher";
        }

        if ( !isDefinedString( _options.expandDayTooltipText ) ) {
            _options.expandDayTooltipText = "Détails";
        }

        if ( !isDefinedString( _options.listAllEventsTooltipText ) ) {
            _options.listAllEventsTooltipText = "Voir tous les événements";
        }

        if ( !isDefinedString( _options.listWeekEventsTooltipText ) ) {
            _options.listWeekEventsTooltipText = "Voir les événements de la semaine";
        }
        ...
        if ( !isDefinedString( _options.isAllDayText ) ) {
            _options.isAllDayText = "Se passe toute la journée:";
        }

        if ( !isDefinedString( _options.titleText ) ) {
            _options.titleText = "Titre:";
        }
        ...
        if ( !isDefinedString( _options.locationText ) ) {
            _options.locationText = "Ville:";
        }

        if ( !isDefinedString( _options.addText ) ) {
            _options.addText = "Ajouter";
        }

        if ( !isDefinedString( _options.updateText ) ) {
            _options.updateText = "Mettre à jour";
        }

        if ( !isDefinedString( _options.cancelText ) ) {
            _options.cancelText = "Annuler";
        }

        if ( !isDefinedString( _options.removeEventText ) ) {
            _options.removeEventText = "Supprimer";
        }

        if ( !isDefinedString( _options.addEventTitle ) ) {
            _options.addEventTitle = "Ajouter un événement";
        }

        if ( !isDefinedString( _options.editEventTitle ) ) {
            _options.editEventTitle = " Éditer un événement";
        }

        if ( !isDefinedString( _options.exportStartFilename ) ) {
            _options.exportStartFilename = "evenements_exportes_";
        }

        if ( !isDefinedString( _options.fromTimeErrorMessage ) ) {
            _options.fromTimeErrorMessage = "Veuillez choisir une date de début valide.";
        }

        if ( !isDefinedString( _options.toTimeErrorMessage ) ) {
            _options.toTimeErrorMessage = "Veuillez choisir une date de fin valide.";
        }

        if ( !isDefinedString( _options.toSmallerThanFromErrorMessage ) ) {
            _options.toSmallerThanFromErrorMessage = "Veuillez choisir une date de fin postérieure à la date de début.";
        }

        if ( !isDefinedString( _options.titleErrorMessage ) ) {
            _options.titleErrorMessage = "Veuillez indiquer un titre.";
        }
        ...
        if ( !isDefinedString( _options.allEventsText ) ) {
            _options.allEventsText = "Tous les événements";
        }

        if ( !isDefinedString( _options.toTimeText ) ) {
            _options.toTimeText = "à";
        }
        
        if ( !isDefinedString( _options.confirmEventRemoveTitle ) ) {
            _options.confirmEventRemoveTitle = "Supprimer l'événement";
        }
        
        if ( !isDefinedString( _options.confirmEventRemoveMessage ) ) {
            _options.confirmEventRemoveMessage = "Supprimer cet événement sera définitif, voulez-vous continuer ?";
        }
        ...
        if ( !isDefinedString( _options.selectExportTypeTitle ) ) {
            _options.selectExportTypeTitle = "Sélection du type d'exportation";
        }
        
        if ( !isDefinedString( _options.selectColorsText ) ) {
            _options.selectColorsText = "Sélection des couleurs";
        }
        
        if ( !isDefinedString( _options.backgroundColorText ) ) {
            _options.backgroundColorText = "Couleur d'arrière-plan:";
        }
        
        if ( !isDefinedString( _options.textColorText ) ) {
            _options.textColorText = "Couleur du texte:";
        }
        
        if ( !isDefinedString( _options.borderColorText ) ) {
            _options.borderColorText = "Couleur de la bordure:";
        }
        
        if ( !isDefinedString( _options.searchEventsTitle ) ) {
            _options.searchEventsTitle = "Chercher des événements";
        }
        
        if ( !isDefinedString( _options.previousText ) ) {
            _options.previousText = "Précédent";
        }
        
        if ( !isDefinedString( _options.nextText ) ) {
            _options.nextText = "Suivant";
        }
        
        if ( !isDefinedString( _options.matchCaseText ) ) {
            _options.matchCaseText = "Respecter les majuscules/minuscules";
        }
        ...
        if ( !isDefinedString( _options.enableFullScreenTooltipText ) ) {
            _options.enableFullScreenTooltipText = "Activer mode plein écran";
        }
        
        if ( !isDefinedString( _options.disableFullScreenTooltipText ) ) {
            _options.disableFullScreenTooltipText = "Désactiver mode plein écran";
        }
        ...
        if ( !isDefinedString( _options.expandMonthTooltipText ) ) {
            _options.expandMonthTooltipText = "Détails du mois";
        }
        ...
        if ( !isDefinedString( _options.viewWeekEventsText ) ) {
            _options.viewWeekEventsText = "Voir les événements du mois";
        }
        ...
        if ( !isDefinedString( _options.startsWithText ) ) {
            _options.startsWithText = "Commence avec";
        }

        if ( !isDefinedString( _options.endsWithText ) ) {
            _options.endsWithText = "Finit avec";
        }

        if ( !isDefinedString( _options.containsText ) ) {
            _options.containsText = "Contient";
        }
        ...
        if ( !isDefinedString( _options.advancedText ) ) {
            _options.advancedText = "Recherche avancée";
        }
        ...
        if ( !isDefinedString( _options.notSearchText ) ) {
            _options.notSearchText = "Ne concerne pas";
        }
    ...
    function getStandardHolidays() {
        return [
            ...
            },
            {
                day: 31,
                month: 12,
                title: "Réveillon du jour de l'An"
            }
        ];
    }
